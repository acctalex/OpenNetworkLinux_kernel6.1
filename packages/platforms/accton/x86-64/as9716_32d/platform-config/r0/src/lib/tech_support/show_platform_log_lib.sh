...
bios_boot_flash_sysfs="/sys/bus/i2c/devices/0-0065/bios_flash_id"
...
support_sfp=1
support_qsfpdd=1
sfp_eeprom_bus_array=(57 58)
qsfp_eeprom_bus_array=(25 26 27 28 29 30 31 31 33 34 \
...
function _qsfpdd_get_lp_mode_func {
    #cpld no support lpmode register
    echo ""
}
